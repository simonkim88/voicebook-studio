...
class TTSWorker(QThread):
    ...
    def __init__(self, text, output_path, voice="Sohee", instruct_text="", device="cpu",
        ...
        #     2500   6.0         2.40, 2.23   7.26G   ← 1.29배, 여유 0.74G
        #     3000   6.0         2.26, 2.00   7.54G   (실효가 같아 이득 없음)
        #
        # 2500 은 8GB 카드에서 여유를 남기는 선의 최대치다. VRAM 이 더 큰
        # GPU 라면 올릴 값어치가 있다 — 예산 4000(실효 8.0)에서 RTF 2.28 까지
        # 올라갔지만 10.25G 를 요구해 이 카드에서는 쓸 수 없었다.
        #
